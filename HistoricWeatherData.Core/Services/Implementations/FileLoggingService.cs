...
namespace HistoricWeatherData.Core.Services.Implementations
{
    ...
    // Composite logging service that writes to both console and file
    public class CompositeLoggingService : ILoggingService
    {
        ...
        public void LogApiRequest(string serviceName, string url, Dictionary<string, string>? parameters = null)
        {
            _consoleLogger.LogApiRequest(serviceName, url, parameters);
        ...
        public IReadOnlyList<ApiErrorLog> GetErrorLogs()
        {
            return _fileLogger.GetErrorLogs();
        }

        public Dictionary<string, int> GetErrorCounts()
        {
            return _fileLogger.GetErrorCounts();
        }

        public void ClearErrorLogs()
        {
            _fileLogger.ClearErrorLogs();
        }

        public string GetLogDirectory()
        {
            return _fileLogger.GetLogDirectory();
        }
        ...
        public string GetErrorLogFilePath()
        {
            return _fileLogger.GetErrorLogFilePath();
        }
    }
}